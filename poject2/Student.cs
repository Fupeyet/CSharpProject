...
namespace poject2
{
    public partial class Student : MaterialForm
    {
        ...
        public Student()
        {
            ...
            NpgsqlCommand command = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='"+asd1+"'", connection);
            ...
            NpgsqlCommand command1 = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='" + asd1 + "'", connection);
            ...
            int p2 = 0;
            int p3 = 0;
            NpgsqlCommand command2 = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='" + asd2 + "'", connection);
            ...
            NpgsqlCommand command3 = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='" + asd2 + "'", connection);
            ...
            int p4 = 0;
            int p5 = 0;
            NpgsqlCommand command4 = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='" + asd3 + "'", connection);
            ...
            NpgsqlCommand command5 = new NpgsqlCommand("SELECT * FROM qa WHERE typeq='" + asd3 + "'", connection);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            db db1 = new db();
            string insertQuery = "insert into results (FIO, login, pass, result1, result2, result3) values ('" + Log.FIO + "', '" + Log.login + "', '" + Log.pass + "','" + Result1 + "', '" + Result2 + "','" + Result3 + "');";
